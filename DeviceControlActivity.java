...
public class DeviceControlActivity extends Activity {
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        // Removed all the code that was pertaining to the services and characteristic listings
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            ArrayList<BluetoothGattCharacteristic> charas = new ArrayList<>(gattCharacteristics);
    ...
    public void buttonOn(View view) {
        BluetoothLeService.writeLedCharacteristic(true, mGattCharacteristics);
    }

    public void buttonOff(View view) {
        BluetoothLeService.writeLedCharacteristic(false, mGattCharacteristics);
    }
